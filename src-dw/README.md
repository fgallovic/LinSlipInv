...
Additional modifications have been made by J. Zahradník and F. Galloviè.
...
./calculate.sh
```
The first script compiles the required codes and runs prepare.f90. The second script executes parallel (if possible) evaluation of Green's functions.
