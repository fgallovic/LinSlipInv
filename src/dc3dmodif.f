C      SUBROUTINE  DC3D(ALPHA,X,Y,Z,DEPTH,DIP,                           04610005
C     *              AL1,AL2,AW1,AW2,DISL1,DISL2,DISL3,                  04620005
C     *              UX,UY,UZ,UXX,UYX,UZX,UXY,UYY,UZY,UXZ,UYZ,UZZ,IRET)  04630005
C FG:
      SUBROUTINE  DC3Dmodif(ALPHA,XS,YS,DEPTH,STRIKE,DIP,RAKE,          04610005
     *              ALENG,AWIDT,DISL,XR,YR,ZR,UX,UY,UZ,IRET)            04630005
      IMPLICIT REAL*8 (A-H,O-Z)                                         04640005
      REAL*4   ALPHA,XR,YR,ZR,XS,YS,DEPTH,UX,UY,UZ,                     04650005
     *         STRIKE,DIP,RAKE,ALENG,AWIDT,DISL,EPS,PI                  04660005
	INTEGER  IRET
C                                                                       04670005
C********************************************************************   04680005
C*****                                                          *****   04690005
...
C                                                                       04920005
      ...
      DATA  F0,EPS,PI/ 0.D0, 1.D-6, 3.1415926535 /                      04960005	  
C-----                                                                  04970005
...
C FG:      
	...
	AW1=-AWIDT/2.
	AW2=AWIDT/2.
	DISL1=DISL*cos(RAKE/180.*PI)
      DISL2=DISL*sin(RAKE/180.*PI)
	DISL3=0.
      X=   (XR-XS)*cos(STRIKE/180.*PI)+(YR-YS)*sin(STRIKE/180.*PI)
	Y=-(-(XR-XS)*sin(STRIKE/180.*PI)+(YR-YS)*cos(STRIKE/180.*PI))
	Z=ZR
C-----                                                                  04970005
...
C      UX=U(1)                                                           06280005
C      UY=U(2)                                                           06290005
      UX=U(1)*cos(STRIKE/180.*PI)-(-U(2))*sin(STRIKE/180.*PI)
	UY=U(1)*sin(STRIKE/180.*PI)+(-U(2))*cos(STRIKE/180.*PI)
      UZ=U(3)                                                           06300005
C-----                                                                  06240005
